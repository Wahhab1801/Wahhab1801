...
Calendly._util.assign = function assign(target, varArgs) {
...
(function () {
  var createBadgeWidget,
    createInlineWidgets,
    extractBadgeOptions,
    findInlineParentElement,
    shouldSkipAutoLoadInlineWidget;
...
(function () {
  Calendly.Iframe = (function () {
    ...
    Iframe.prototype.getUtmParamsFromHost = function () {
      ...
      queryStringParams = Calendly._url.extractQueryStringParams(
    ...
    Iframe.prototype.getUtmParams = function () {
      ...
      return Calendly._util.snakeCaseKeys(
        Calendly._util.pick(this.options.utm, keyFilters)
      );
    };
    ...
    Iframe.prototype.getPrefillParams = function () {
      ...
      params = Calendly._util.snakeCaseKeys(
        Calendly._util.pick(this.options.prefill, keyFilters)
      );
